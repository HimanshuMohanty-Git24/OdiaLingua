...
const Index = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "The perfect blend of technology and cultural preservation.",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-neutral-600 max-w-2xl mx-auto px-4">
              Through seamless AI-driven conversations, real-time knowledge, and authentic Odia speech synthesis
            </p>
          </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                          <div className="text-primary-dark">{testimonial.icon}</div>
                        </div>
                        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              <div className="flex space-x-6">
                <a
                  href="#"
                  className="text-neutral-800 hover:text-primary-dark transition-colors"
                >
                  Privacy
                </a>
                <a
